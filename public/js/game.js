	...
	window.yodorada.buzzwordBlast = function() {
			...
			this.init = function(object) {
				...
				switch (object) {
					case "laser":
						...
						break;
					case "words":
						path = "sounds/wordproblems.wav";
						break;
					case "explosion":
						path = "sounds/explosion.wav";
						break;
					case "win":
						path = "sounds/you-win.wav";
						break;
					case "loss":
						path = "sounds/i-win.wav";
						break;
					case "ladies":
						path = "sounds/ladies.wav";
						break;
					case "gameover":
						path = "sounds/gameover.wav";
						break;
					case "echo":
						path = "sounds/echo.wav";
						break;
					case "lifeup":
						path = "sounds/lifeup.wav";
						break;
					case "playerdied":
						path = "sounds/playerdied.wav";
						break;
					case "perfect":
						path = "sounds/perfect-score.wav";
						break;
					case "enough":
						path = "sounds/enough.wav";
						break;
		...
		var Game = {
			...
			initAudio: function() {
				...
				this.gameAudio = new Audio("sounds/arcadeloop.mp3");
				this.gameAudio.loop = true;
				this.gameAudio.volume = .07;
				this.gameAudio.load();

				this.atmoAudio = new Audio("sounds/atmospheric.mp3");

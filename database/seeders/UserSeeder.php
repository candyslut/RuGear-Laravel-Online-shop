...
class UserSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $users = [
            ...
            ['name' => 'Киборг404',          'gender' => null,     'chain' => 5, 'about' => 'Не найден. Хотя вот он я.'],
            ['name' => 'ЗвукТишины',         'gender' => null,     'chain' => 6, 'about' => 'Слушаю ультразвук и читаю даташиты перед сном.'],
            ['name' => 'НоутбукДух',         'gender' => null,     'chain' => 7, 'about' => 'Призрак в машине. Буквально.'],

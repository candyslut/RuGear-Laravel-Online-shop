<x-shop-layout>
    ...
    <style>
        ...
        /* ════════════════════════════════════════════════════════════
           СВЕТЛАЯ ТЕМА · акцент на блоках и форме заявки
           Тёмные классы перекрашиваются в светлые (border-gray-800 →
           #e2e5ea), из-за чего белые карточки и поля формы сливались
           с фоном. Усиливаем границы карточек и полей, надпись на
           рыжей кнопке отправки делаем белой. Оранжевую фокус-рамку
           полей сохраняем через :not(:focus). Скоуп — <main>.
           ──────────────────────────────────────────────────────────── */
        [data-theme="light"] main .bg-\[\#161920\],
        [data-theme="light"] main .bg-gray-800\/10 { border-color: #cdd4e0; }

        /* Поля формы заявки: чёткая граница, но фокус остаётся рыжим */
        [data-theme="light"] main .bg-gray-900\/50:not(:focus) { border-color: #cdd4e0; }

        /* Рыжая кнопка «Отправить данные»: белая надпись вместо чёрной */

    ...
    <div class="mb-12 bg-[#161920] border border-gray-800 p-6 rounded-3xl shadow-2xl relative overflow-hidden">
        ...
        <form action="{{ route('products.index') }}" method="GET" class="relative z-10 grid grid-cols-1 md:grid-cols-4 gap-6 items-end">
            <div class="md:col-span-1">
                <label class="text-[10px] font-black text-gray-500 uppercase tracking-widest ml-1 mb-2 block text-orange-500/70">Поиск...</label>
                <div class="relative">
            ...
            <div>
                <label class="text-[10px] font-black text-gray-500 uppercase tracking-widest ml-1 mb-2 block">Категория</label>
